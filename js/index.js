...
window.onload = (event) => {
  ...
  window.addEventListener("keydown", (e) => console.log({type: e.typeArg, eventData: e.KeyboardEventInit});//renderDelegate.postMessage({type: e.typeArg, eventData: e.KeyboardEventInit}));
