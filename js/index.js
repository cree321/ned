...
window.onload = (event) => {
  ...
  window.addEventListener("keydown", (e) => console.log({type: "keydown", eventData: e.KeyboardEventInit}));//renderDelegate.postMessage({type: e.typeArg, eventData: e.KeyboardEventInit}));
